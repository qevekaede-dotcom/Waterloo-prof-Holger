#!/usr/bin/env python3
"""Create compact transport summaries from the BoltzTraP2 dope trace (Rb2Cu2SnS4)."""
...
TRACE = BT2_DIR / "Rb2Cu2SnS4.dope.trace"
QE_SOURCE = CANDIDATE / "qe" / "tmp" / "final" / "Rb2Cu2SnS4.save"
RELAXED_CIF = CANDIDATE / "structures" / "Rb2Cu2SnS4.relaxed.cif"
